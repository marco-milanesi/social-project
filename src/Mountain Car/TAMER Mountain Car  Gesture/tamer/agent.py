...
class Tamer:
    ...
    def _train_episode(self, episode_index, disp, cam):
            ...
            for ts in count():
                ...
                if not self.tame:
                    ...
                    while time.time() < now + self.ts_len:
                        ...
                        human_reward = disp.get_scalar_feedback(cam)
    ...
    async def train(self, cam, model_file_to_save=None):
        """
        ...
        for i in range(self.num_episodes):
            tot_reward = self._train_episode(i, disp, cam)
